...
printf("===RODADA 1===\n");    
    ...
    unsigned int resultado1 = (populacao1 > populacao2);

printf("Jogador 1, sua populacao e maior que a do jogador 2: %d, voce ganhou!", resultado1);
     printf("\n================\n");
...
printf("===RODADA 2===\n");
    ...
    unsigned int resultado2 = (area1 > area2);

printf("Jogador 1, sua area e maior que a do jogador 2: %d, voce ganhou!", resultado2);
        printf("\n================\n");
...
printf("===RODADA 3===\n");
    ...
    unsigned int resultado3 = (pib1 > pib2);

printf("Jogador 1, seu PIB e maior que o do jogador 2: %d, voce ganhou!", resultado3);
        printf("\n================\n");
...
printf("===RODADA 4===\n");
    ...
    unsigned int resultado4 = (pontos1 > pontos2);

printf("Jogador 2, seu numero de pontos turisticos e maior que o do jogador 1: %d, voce ganhou!", resultado4);
        printf("\n================\n");
...
printf("===RODADA 5===\n");
    ...
    unsigned int resultado5 = (densidade1 > densidade2);

printf("Jogador 1, sua densidade populacional e maior que a do jogador 2: %d, voce ganhou!", resultado5);
        printf("\n================\n");
...
printf("===RODADA 6===\n");
    ...
    unsigned int resultado6 = (pibpercapita1 > pibpercapita2);

    printf("Jogador 1, seu PIB per capita e maior que o do jogador 2: %d, voce ganhou!", resultado6);
        printf("\n================\n");
...
printf("===RODADA FINAL===\n");
    ...
    unsigned int resultado7 = (superpoder1 > superpoder2);

    printf("Jogador 1, seu super poder e maior que o do jogador 2: %d, voce ganhou!\n", resultado7);

printf("Jogador 1 venceu com 6 pontos a 1! PARABENS!!!");
 printf("\n================\n");
